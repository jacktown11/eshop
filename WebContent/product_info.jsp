...
<body>
		...
		<div class="row">
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div><a href="${pageContext.request.contextPath }/product?method=productList&cid=${cid}&currentSlide=${currentSlide}">返回商品列表</a></div>
				</div>
			</div>
			<div class="clear"></div>
	...
	<script type="text/javascript">
		function addToCart(){
			window.location.href='${pageContext.request.contextPath}/product?method=addToCart&pid=${product.pid}&quantity='+$('#quantity').val();
		}
	</script>
