...
<body>
		...
		<div class="row">
			...
			<div class="col-md-5">
				<div
					...
					<div style="color: red; margin: 4px auto;">${error}</div>
					<form class="form-horizontal" action="${pageContext.request.contextPath }/user?method=login" method="POST">
						...
						<div class="form-group">
							<label for="confirmpwd" class="col-sm-2 control-label">密码</label>
							<div class="col-sm-6">
	...
	<script type="text/javascript">
		$('#checkImg').on('click', function(){
			$(this).attr('src', '${pageContext.request.contextPath }/checkImg?time='+Date.now());
		});
	</script>
